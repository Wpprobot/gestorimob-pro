...
// Observe elements
document.querySelectorAll('.bento-card, .step-card, .price-card, .faq-item, .form-wrapper').forEach(el => {
    observer.observe(el);
});
...
// Stagger animation delays for bento cards
document.querySelectorAll('.bento-card').forEach((card, index) => {
    card.style.transitionDelay = `${index * 0.1}s`;
});

// Stagger animation delays for pricing cards
...
console.log('🚀 Wpprobot Premium Landing Page Loaded!');
